<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCustomer.aspx.cs" Inherits="WebApplication3.ViewCustomer" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <h1 class="mt-5 mb-5" style="text-align:center; font-size:35px; color: white;" >Customer Information</h1>
    <div class="GridView">
